...
app.post('/api/users', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        userModel_1.createUserSchema.parse(req.body);
...
app.get('/api/users', (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const users = yield userModel_1.default.find({}, 'username fullName age email address');
        res.json({
            success: true,
...
app.get('/api/users/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield userModel_1.default.findOne({ userId: req.params.userId }, '-password');
        if (user) {
            res.json({
                success: true,
...
app.put('/api/users/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield userModel_1.default.findOneAndUpdate({ userId: req.params.userId }, req.body, { new: true, select: '-password' });
        if (user) {
            res.json({
                success: true,
...
app.delete('/api/users/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield userModel_1.default.findOneAndDelete({ userId: req.params.userId });
        if (user) {
            res.json({
                success: true,
